...
#ifndef __ARCH_ARM_MACH_MSM_BOARD_DELUXE_J_H
#define __ARCH_ARM_MACH_MSM_BOARD_DELUXE_J_H
...
int __init deluxe_j_init_keypad(void);
...
extern struct rpm_regulator_platform_data
	deluxe_j_rpm_regulator_pdata __devinitdata;

extern struct regulator_init_data deluxe_j_saw_regulator_pdata_8921_s5;
extern struct regulator_init_data deluxe_j_saw_regulator_pdata_8921_s6;
extern struct regulator_init_data deluxe_j_saw_regulator_pdata_8821_s0;
extern struct regulator_init_data deluxe_j_saw_regulator_pdata_8821_s1;

struct mmc_platform_data;
int __init apq8064_add_sdcc(unsigned int controller,
		struct mmc_platform_data *plat);

void deluxe_j_init_mmc(void);
int deluxe_j_wifi_init(void);
void deluxe_j_init_gpiomux(void);
void deluxe_j_init_pmic(void);

#if 1	
extern struct platform_device deluxe_j_msm_rawchip_device;
#endif
extern struct msm_camera_board_info deluxe_j_camera_board_info;
extern struct msm_camera_board_info deluxe_j_camera_board_info_xb;

void deluxe_j_init_cam(void);

#define APQ_8064_GSBI1_QUP_I2C_BUS_ID 0
#define APQ_8064_GSBI3_QUP_I2C_BUS_ID 3
#define APQ_8064_GSBI4_QUP_I2C_BUS_ID 4

void deluxe_j_init_fb(void);
